...
namespace Squares.Model
{
    ...
    public class SquaresGameModel
    {
        ...
        /// </summary>
        public Int32 TableSize { get { return _tableSize; } set { _tableSize = value; OnSizeChanged(); }
        }
        ...
        /// <summary>
        ///  Trigger an event to indicate, that the game was created.
        /// </summary>
        ...
        /// <summary>
        ///  Trigger an event to indicate, that the game table size was changed.
        /// </summary>
