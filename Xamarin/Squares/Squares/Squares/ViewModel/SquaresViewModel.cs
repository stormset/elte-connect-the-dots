...
namespace Squares.ViewModel
{
    ...
    public class SquaresViewModel : ViewModelBase
    {
        ...
        public Boolean Is3x3
        {
            ...
            set
            {
                if (value == true && TableSize != 3)
                {
                    OnSizeChangeRequested(3);
                }
            }
        }
        ...
        public Boolean Is5x5
        {
            ...
            set { 
                if (value == true && TableSize != 5)
                {
                    OnSizeChangeRequested(5);
                }
            }
        }
        ...
        public Boolean Is9x9
        {
            ...
            set
            {
                if (value == true && TableSize != 9)
                {
                    OnSizeChangeRequested(9);
                }
            }
        }
        ...
        /// <param name="updateView">Tells weather to update the view model state immediately after construction.</param>
        public SquaresViewModel(SquaresGameModel model, Boolean updateView = true)
        {
